...
const LocationComponent = () => {
  ...
  return (
    <div className="absolute top-[63%] right-[7%] transform -translate-y-1/2 flex items-center gap-1">
      {/* Location Name Div */}
      ...
      <div className="flex items-center justify-center px-4 py-1.5 bg-black/70 text-gray-500 rounded-md cursor-pointer hover:bg-black/80 transition">
        <span className="text-lg">&gt;</span>
      </div>
    </div>
  );
